...
module.exports.run = async (bot, message, args) => {
    ...
    if (args[1] == "setup") {
        ...
        embed.setDescription('Please do ``LN!ticket open`` to create a ticket!');
    ...
    let embed2 = new Discord.MessageEmbed()
        ...
        .setColor(color)
        .setFooter("Please do LN!ticket close when you're finished!")

    if (args[1] == "open") {
        let ticketcategory = message.guild.channels.cache.find(c => c.name == "⚡ Support ⚡ Suggestions ⚡" && c.type == "category")
        ...
        message.guild.channels.create(`ticket-${message.author.username}`, {
            ...
            permissionOverwrites: [
                ...
                {
                    allow: 'VIEW_CHANNEL',
                    id: '727000288590037044'
                },
                {
                    allow: 'VIEW_CHANNEL',
                    id: '735239724733694042'
                }
            ]
        })
            .then(channel => {
